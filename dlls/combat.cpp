...
void CBaseEntity::FireBullets( ULONG cShots, Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iBulletType, int iTracerFreq, int iDamage, entvars_t *pevAttacker )
{
	...
	for( ULONG iShot = 1; iShot <= cShots; iShot++ )
	{
		...
		if( iDamage )
		{
			flDamage = (float)iDamage;
		}
		else switch( iBulletType )
		{
		default:
		case BULLET_MONSTER_9MM:  flDamage = gSkillData.monDmg9MM;  break;
		case BULLET_MONSTER_MP5:  flDamage = gSkillData.monDmgMP5;  break;
		case BULLET_MONSTER_12MM: flDamage = gSkillData.monDmg12MM; break;
		case BULLET_NONE:         flDamage = 50.0f;                 break;
		}

		CBulletProjectile::BulletCreate( vecSrc, vecDir, flDamage, iBulletType, ENT( pevAttacker ) );
	}
}
...
Vector CBaseEntity::FireBulletsPlayer( ULONG cShots, Vector vecSrc, Vector vecDirShooting, Vector vecSpread, float flDistance, int iBulletType, int iTracerFreq, int iDamage, entvars_t *pevAttacker, int shared_rand )
{
	...
	for( ULONG iShot = 1; iShot <= cShots; iShot++ )
	{
		...
		{
		default:
		case BULLET_PLAYER_9MM:      flDamage = gSkillData.plrDmg9MM;      break;
		case BULLET_PLAYER_MP5:      flDamage = gSkillData.plrDmgMP5;      break;
		case BULLET_PLAYER_BUCKSHOT: flDamage = gSkillData.plrDmgBuckshot; break;
		case BULLET_PLAYER_357:      flDamage = gSkillData.plrDmg357;      break;
		case BULLET_NONE:            flDamage = 50.0f;                     break;
		}
